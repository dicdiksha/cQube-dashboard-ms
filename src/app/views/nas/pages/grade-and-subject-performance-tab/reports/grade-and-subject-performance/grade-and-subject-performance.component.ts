...
@Component({
  selector: 'app-grade-and-subject-performance',
  templateUrl: './grade-and-subject-performance.component.html',
  styleUrls: ['./grade-and-subject-performance.component.scss']
})
export class GradeAndSubjectPerformanceComponent implements OnInit {
  reportName: string = 'grade_and_subject_performance';
  filters: any = [];
  levels: any;
  reportData: any = {
    reportName: "Grade & Subject Performance"
  };
  title: string = 'Grade & Subject Performance'
  selectedYear: any;
  selectedMonth: any;
  startDate: any;
  endDate: any;

...
import { config } from './config/udise_apex_config';
import { environment } from 'src/environments/environment';
import { DomSanitizer, SafeResourceUrl } from '@angular/platform-browser';

@Component({
    selector: 'app-udise',
    templateUrl: './udise-apex.component.html',
    styleUrls: ['./udise-apex.component.scss']
})
export class UdiseComponent implements OnInit, AfterViewInit {
    loadTabs = false;
    rbacDetails: any;
    tabIndex;
    selectedTabLabel;
    tabs: any = [];
    programName: any = 'udise-apex';

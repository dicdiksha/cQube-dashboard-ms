...
@Component({
  selector: 'app-prashast-merics-number',
  templateUrl: './prashast-merics-number.component.html',
  styleUrls: ['./prashast-merics-number.component.scss']
})
export class PrashastMericsNumberComponent implements  OnInit {

  reportName: string = 'prashast_metrics';
  filters: any = [];
  levels: any;
  reportData: any = [];

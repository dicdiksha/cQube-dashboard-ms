...
@Component({
  ...
  templateUrl: './learning-sessions-on-potential-users.component.html',
  styleUrls: ['./learning-sessions-on-potential-users.component.scss']
})
export class LearningSessionsOnPotentialUsersComponent implements OnInit {
  reportName: string = 'learning_sessions_on_potential_users';
  filters: any = [];
  levels: any;
  reportData: any = {

...
@Component({
  selector: 'app-nipun-bharat-metrics',
  templateUrl: './nipun-bharat-metrics.component.html',
  styleUrls: ['./nipun-bharat-metrics.component.scss']
})
export class NipunBharatMetricsComponent implements OnInit {

  reportName: string = 'nipun_bharat_metrics';
  filters: any = [];
  levels: any;
  reportData: any = [];

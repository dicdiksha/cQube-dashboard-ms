...
import { config } from 'src/app/views/nipun-bharat/config/nipun_bharat_config';
import { ReportDrilldownService } from 'src/app/core/services/report-drilldown/report-drilldown.service';
import { CommonService } from 'src/app/core/services/common/common.service';


@Component({
  selector: 'app-module-wide-status',
  templateUrl: './module-wide-status.component.html',
  styleUrls: ['./module-wide-status.component.scss']
})
export class ModuleWideStatusComponent  implements OnInit, OnDestroy {
  reportName: string = 'module_wide_status';
  filters: any = [];
  levels: any;
  reportData: any = {
    reportName: "Module-wide Status"
  };
  title: string = 'Module-wide Status'
  selectedYear: any;
  selectedMonth: any;
  startDate: any;
  endDate: any;

        ...
        "filters": [
            {
                ...
                "actions": {
                    "queries": {
                        "bigNumber1": "select dm.metric_value as outcome from dimensions.mainmetrics dm where  dm.program_id='pgi' and dm.metric_name ='Learning Outcomes & Quality' and dm.metric_type ='Vanity Metric'",
                        "bigNumber2": "select dm.metric_value as access from dimensions.mainmetrics dm where  dm.program_id='pgi' and dm.metric_name ='Access' and dm.metric_type ='Vanity Metric'",
                        "bigNumber3": "select dm.metric_value as infra_score from dimensions.mainmetrics dm where  dm.program_id='pgi' and dm.metric_name ='Infastructure & Facilities' and dm.metric_type ='Vanity Metric'",
                        "bigNumber4": "select dm.metric_value as equity from  dimensions.mainmetrics dm where  dm.program_id='pgi' and dm.metric_name ='Equity' and dm.metric_type ='Vanity Metric'",
                        "bigNumber5": "select dm.metric_value as governance_processes from dimensions.mainmetrics dm where  dm.program_id='pgi' and dm.metric_name ='Governance Processes' and dm.metric_type ='Vanity Metric'",
                     },
                    "level": "state"
                }
            },
